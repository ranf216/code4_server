module.exports =
{
            "create_call"                       : {
                                                    ...
                                                    "#token"                        : "s",
                                                    "category"                      : "s***Call category: " + $DataItems.getListForApiDoc("call_category"),
                                                    ...
                                                    "priority"                      : "o:s:normal***Priority: " + $DataItems.getListForApiDoc("call_priority"),
            ...
            "get_calls"                         : {
                                                    ...
                                                    "#token"                        : "s",
                                                    "status"                        : "o:s:***Filter by status: " + $DataItems.getListForApiDoc("call_status"),
                                                    "category"                      : "o:s:***Filter by category: " + $DataItems.getListForApiDoc("call_category"),
            ...
            "update_call"                       : {
                                                    ...
                                                    "priority"                      : "o:s:***Priority (resident only): " + $DataItems.getListForApiDoc("call_priority"),
